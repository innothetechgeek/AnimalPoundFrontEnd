package www.innothetechgeek.za.petmanagementapp.Repository.rest.adoption;
...
public class RestAdoption implements RestAPI<Adoption, Long> {
   ...
   final String BASE_URL = "https://animalpoundapp.herokuapp.com/";
    ...
    public Adoption get(Long id) {
        ...
        final String url = BASE_URL+"adoption/"+id.toString();
